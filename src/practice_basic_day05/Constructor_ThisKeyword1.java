...
public class Constructor_ThisKeyword1 {
    /*
    ...
    int yas=40;
    static String isim="ayse";


    Constructor_ThisKeyword1(){

    }
    Constructor_ThisKeyword1(int yas,String isim){
        this.yas=yas;
        this.isim="fatma";
    ...
    public static void main(String[] args) {
        Constructor_ThisKeyword1 obj=new Constructor_ThisKeyword1();
